...
<div class="super_container">
	...
	@section('header')
		<header class="header trans_300">
			...
			@section('top_nav')
				<div class="top_nav" style="background-color: #FFF5EE;">
					<div class="container">
						<div class="row">
							<div class="col-md-6">
							...
							<div class="col-md-6 text-right">
								<div class="top_nav_right">
									<ul class="top_nav_menu">
										...
										<li class="account" style="background-color: #FFF5EE;">
											<a href="#">
												My Account
				...
				<div class="col-lg-6">
					<div class="footer_nav_container d-flex flex-sm-row flex-column align-items-center justify-content-lg-start justify-content-center text-center">
						<ul class="footer_nav">
							...
							<li><a href="contact">Contact us</a> on  our email address ~ <a href="#"> PaulinesBoutique@gmail.com</a>
							<a href="#"><i class="bi bi-envelope-heart"></i></a></li>
						</ul>
					</div>
				</div>
				<div class="col-lg-12">
					<div class="footer_nav_container">
						<div class="cr">©2023 All Rights Reserverd. Made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="#">Catigay|Elen|Falsario</a>  in <a href="#">Application Development 2k23</a></div>
					</div>
				</div>
			</div>
		</div>
